...
validators = {
    ('ask', 'GET'): {'args': {'required': [], 'properties': {'message': {'description': 'Please enter your message...', 'type': 'string'}}}},
}

filters = {
    ('ask', 'GET'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}},
}
